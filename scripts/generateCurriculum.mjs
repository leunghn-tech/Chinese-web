...
const chineseMap = {
  P1:['聆聽、說話與生活語文','常用字、詞語與句子表達','兒歌、童話與閱讀理解','看圖寫句與筆順','品德情意、思維與語文自學'], P2:['閱讀、標點與生活語文','四素句與句子組織','童話、寓言與閱讀理解','標點、通知與賀卡寫作','品德情意、思維與語文自學'], P3:['閱讀、文學與品德情意','段落結構與閱讀策略','記敍文、說明文與閱讀理解','日記、書信與修辭寫作','文學、品德情意與語文自學'], P4:['閱讀、文學與中華文化','中心思想、寫作目的與表達方式','散文、說明文與閱讀理解','描寫、說明與修辭寫作','品德情意、思維與語文自學'], P5:['閱讀、文學與中華文化','篇章結構、修辭與閱讀策略','小說、劇本、科普與閱讀理解','議論、說明與篇章佈局寫作','文學、中華文化、品德情意與語文自學'], P6:['閱讀、文學與中華文化','預測、提問、澄清與摘要','淺易文言文與閱讀理解','夾敍夾議、建議書與演講辭','中華文化、思維與語文自學'],
