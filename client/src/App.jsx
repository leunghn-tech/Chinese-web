...
export default function App() {
  ...
  const previewUnit = params.get('activity') === 'p1-word-match' ? getChineseQuestionBank('P1').units.find((unit) => unit.id === 'P1-CN-R01') : null;
  ...
  if (screen === 'activity' && activeUnit) return <WordMatchActivity unit={activeUnit} onBack={() => setScreen('catalog')} />;
