...
function ChineseCatalog({ onBack, onHome, initialGrade }) {
...
export default function App() {
  ...
  if (screen === 'catalog') return <ChineseCatalog initialGrade={catalogGrade} onBack={() => setScreen('courses')} onHome={() => setScreen('home')} />;
