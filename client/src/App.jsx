...
export default function App() {
  ...
  const previewUnitId = params.get('activity') === 'p1-sentence-expand' ? 'P1-CN-W01' : params.get('activity') === 'p1-story-structure' ? 'P1-CN-R04' : params.get('activity') === 'p1-punctuation-drop' ? 'P1-CN-R03' : params.get('activity') === 'p1-radical-sort' ? 'P1-CN-R02' : params.get('activity') === 'p1-word-match' ? 'P1-CN-R01' : null;
  ...
  if (screen === 'activity' && activeUnit) return activeUnit.interaction === 'sentence-expand' ? <SentenceExpandActivity unit={activeUnit} onBack={() => setScreen('catalog')} onComplete={markUnitCompleted} /> : activeUnit.interaction === 'story-structure' ? <StoryStructureActivity unit={activeUnit} onBack={() => setScreen('catalog')} onComplete={markUnitCompleted} /> : activeUnit.interaction === 'punctuation-drop' ? <PunctuationDropActivity unit={activeUnit} onBack={() => setScreen('catalog')} onComplete={markUnitCompleted} /> : activeUnit.interaction === 'radical-sort' ? <RadicalSortActivity unit={activeUnit} onBack={() => setScreen('catalog')} onComplete={markUnitCompleted} /> : <WordMatchActivity unit={activeUnit} onBack={() => setScreen('catalog')} onComplete={markUnitCompleted} />;
