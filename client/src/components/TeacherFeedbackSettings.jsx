/* 教師設定面板：以本機儲存記錄音效、動畫與提示錦囊偏好，並通知活動頁立即更新。 */
import { Lightbulb, Settings2, Sparkles, Volume2, VolumeX, X } from 'lucide-react';
import { useState } from 'react';

const DEFAULTS = { sound: true, animation: true, hintSatchel: false, firstWordHint: false };
