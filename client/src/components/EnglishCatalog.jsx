import { ArrowLeft, ChevronRight, Languages, LayoutDashboard, Sparkles } from 'lucide-react';
...
function TopicCard({ unit, grade, completedUnits, onStart }) {
...
export default function EnglishCatalog({ initialGrade = 'P1', onBack, onHome, completedUnits, onStartUnit }) {
  ...
  const catalog = englishCatalog[grade];
  const bank = getEnglishQuestionBank(grade);
