...
export const englishPracticeLinks = {
  ...
  P4: { 'P4-EN-G01': { topic: 'Adjectives & Adverbs', kind: 'core' }, 'P4-EN-G02': { topic: 'Comparatives & Superlatives', kind: 'core' }, 'P4-EN-G03': { topic: 'Modal Verbs 進階情態動詞', kind: 'core' }, 'P4-EN-G04': { topic: 'Reflexive Pronouns 反身代名詞', kind: 'core' }, 'P4-EN-G05': { topic: 'Connectors 進階連接詞', kind: 'core' }, 'P4-EN-R01': { topic: 'Reading Comprehension 閱讀理解', kind: 'reading' } },
  P5: { 'P5-EN-G01': { topic: 'Present Perfect Tense', kind: 'core' }, 'P5-EN-G02': { topic: 'Since, For & Time Markers', kind: 'core' }, 'P5-EN-G03': { topic: 'Passive Voice 被動語態', kind: 'core' }, 'P5-EN-G04': { topic: 'Relative Clauses 關係從句', kind: 'core' }, 'P5-EN-G05': { topic: 'Correlative Conjunctions', kind: 'core' }, 'P5-EN-S01': { topic: 'Present Perfect Tense', kind: 'consolidation' }, 'P5-EN-S02': { topic: 'Passive Voice 被動語態', kind: 'consolidation' }, 'P5-EN-R01': { topic: 'Advanced Reading 閱讀理解', kind: 'reading' } },
  P6: { 'P6-EN-G01': { topic: 'Conditional Sentences', kind: 'core' }, 'P6-EN-G02': { topic: 'Reported Speech 間接引語', kind: 'core' }, 'P6-EN-G03': { topic: 'Gerunds & Infinitives', kind: 'core' }, 'P6-EN-G04': { topic: 'Phrasal Verbs 短語動詞', kind: 'core' }, 'P6-EN-RW01': { topic: 'Conditional Sentences', kind: 'consolidation' }, 'P6-EN-RW02': { topic: 'Reported Speech 間接引語', kind: 'consolidation' }, 'P6-EN-R01': { topic: 'Advanced Reading 閱讀理解', kind: 'reading' } },
};
