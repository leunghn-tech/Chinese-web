...
function renderStudy() {
  ...
  document.querySelector("#study-grid").innerHTML = shown.length ? shown.map(unitCard).join("") : `<p class="empty-message">找不到相關重點。試試搜尋「仁」、「借景」或「對比」。</p>`;
...
app.innerHTML = `
  <div class="site-shell">
    ...
    <footer class="footer"><p>中文奪星研習室・繁體中文學習內容</p><p>資料根據所上載的指定文言與白話文寫作手法筆記整理。</p></footer>
  </div>`;
